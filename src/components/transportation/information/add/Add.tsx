...
import type { PricelistFormHandle } from "./sections/PricelistForm";
import PricelistForm from "./sections/PricelistForm";
...
const Add = () => {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      const transportId = localStorage.getItem("transportId") || "";
      ...
      if (pricelistFormData && hasFormData(pricelistFormData)) {
        ...
        for (let i = 0; i < safePricelistData.length; i++) {
          ...
          pricelistFormDataToSubmit.append("vehicle", pricelistItem.vehicle);
          ...
          pricelistFormDataToSubmit.append("transport", transportId);
      ...
      if (processFormData && hasFormData(processFormData)) {
        ...
        for (let i = 0; i < safeProcessData.length; i++) {
          ...
          processFormDataToSubmit.append("transport", transportId);
      ...
      if (paymentFormData && hasFormData(paymentFormData)) {
        ...
        for (let i = 0; i < safePaymentData.length; i++) {
          ...
          paymentFormDataToSubmit.append("transport", transportId);
      ...
      if (termFormData && hasFormData(termFormData)) {
        ...
        for (let i = 0; i < safeTermData.length; i++) {
          ...
          termFormDataToSubmit.append("transport", transportId);
      ...
      if (faqFormData && hasFormData(faqFormData)) {
        ...
        for (let i = 0; i < safeFaqData.length; i++) {
          ...
          faqFormDataToSubmit.append("transport", transportId);
      ...
      alert("Transport information added successfully!");
      navigate(-2);
    } catch (error) {
    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-start p-6 gap-6 bg-gray-100">
      ...
      <div className="w-full lg:w-2xl mt-8">
        <ActionButton
          ...
          title="Add Transport Information"
