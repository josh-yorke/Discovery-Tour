...
const PassPricelist = ({ passId }: PassPricelistsProps) => {
  ...
  const {
    ...
    queryKey: ["pass-pricelists", passId],
    queryFn: () => getPassPricelists(passId),
    enabled: !!passId,
  });
  ...
  const fileQueries = useQueries({
    queries: allFileIds.map((fileId) => ({
      queryKey: ["pass-pricelist-file", fileId],
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xs font-normal text-gray-600">
                Available packages and pricing for this pass
              </p>
            </div>
          </div>
          <RiArrowUpSLine
            ...
            {pricelists.length === 0 ? (
              <div className="w-full text-center py-6 sm:py-8">
                <p className="text-gray-500 text-sm sm:text-base">
                  No pricing information available for this pass.
                </p>
              </div>
            ) : (
                        ...
                        <div className="space-y-3 sm:space-y-4 ml-11 sm:ml-14">
                          {isErrorFiles && (
                            <div className="p-3 bg-red-50 border border-red-200 rounded-2xl">
                              ...
                              <button
                                onClick={() =>
                                  pricelistFileQueries.forEach((q) =>
                                    q.refetch()
                                  )
                                }
