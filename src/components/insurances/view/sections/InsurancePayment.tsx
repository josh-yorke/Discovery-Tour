...
const InsurancePayment = ({ insuranceId }: InsurancePaymentsProps) => {
  ...
  const {
    ...
    queryKey: ["insurance-payments", insuranceId],
    queryFn: () => getInsurancePayment(insuranceId),
    enabled: !!insuranceId,
  });
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xs font-normal text-gray-600">
                Bank account details for insurance payment
              </p>
            </div>
          </div>
          <RiArrowUpSLine
