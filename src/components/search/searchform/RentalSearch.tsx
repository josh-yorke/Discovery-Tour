  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-[#1d2087]">Manage Rentals</h2>
        <p className="text-xs text-gray-500 mt-1">
          Create, edit, and manage your rental bookings
        </p>
      </div>
      ...
      <div className="w-full max-w-4xl">
        <div className="flex items-center gap-2">
          <div className="flex-1">
            <SearchInput
              placeholder="Search rentals by customer name, booking ID, or vehicle..."
              value={searchValue}
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {statusValue && (
                      <p className="text-xs text-gray-500 mt-2">
                        Showing rentals with status: {statusValue}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {vehicleValue && (
                      <p className="text-xs text-gray-500 mt-2">
                        Showing rentals for selected vehicle
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  {(monthValue || dayValue || yearValue) && (
                    <p className="text-xs text-gray-500 mt-2">
                      Showing rentals for {monthValue}/{dayValue}/{yearValue}
                    </p>
                  )}
                </div>
              </div>
