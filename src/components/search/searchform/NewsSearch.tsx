...
const NewsSearch = ({
  ...
  // Only one filter (status), so make it span full width
  const filterColumns = "grid-cols-1";

  return (
    <div className="w-full flex flex-col items-center justify-center gap-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-[#1d2087]">Manage Happenings</h2>
        <p className="text-xs text-gray-500 mt-1">
          Create, edit, and manage your news and happenings
        </p>
      </div>
      ...
      <div className="w-full max-w-4xl">
        <div className="flex items-center gap-2">
          <div className="flex-1">
            <SearchInput
              placeholder="Search happenings by title or content..."
              value={searchValue}
