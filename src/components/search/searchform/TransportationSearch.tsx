    ...
    <div className="w-full flex flex-col items-center justify-center gap-6">
      <div className="text-center">
        ...
        <p className="text-xs text-gray-500 mt-1">
          Create, edit, and manage your transportation services
        </p>
      </div>
      ...
      <div className="w-full max-w-4xl">
        <div className="flex items-center gap-2">
          <div className="flex-1">
            <SearchInput
              placeholder="Search transportation by name or description..."
              value={searchValue}
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-black/6 p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <IconButton
              ...
              title="Create New Transportation"
            ...
            <div className="mt-4 pt-4 border-t border-black/6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {countryValue && (
                    <p className="text-xs text-gray-500 mt-2">
                      Showing transportation in {countryValue}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {typeValue && (
                    <p className="text-xs text-gray-500 mt-2">
                      Showing {typeValue} transportation
                    </p>
                  )}
                </div>
              </div>
