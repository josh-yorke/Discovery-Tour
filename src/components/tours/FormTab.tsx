    ...
    <div className="w-full flex justify-center mb-6">
      <div className="w-full max-w-4xl mx-auto px-4">
        ...
        <div className="hidden md:flex justify-center">
          <div className="inline-flex flex-wrap justify-center gap-1 p-1.5 bg-linear-to-br from-gray-50 to-white rounded-2xl shadow-lg border border-gray-100/50">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              const isActive = formType === tab.id;
              ...
              return (
                <button
                  key={tab.id}
                  onClick={() => handleSelect(tab.id)}
                  className={`flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 group whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-[#1d2087]/50 ${
                    isActive
